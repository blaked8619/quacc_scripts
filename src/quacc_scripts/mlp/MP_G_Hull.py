...
def choose_calc(calc_name, atoms, dispersion_correction, dtype):
    ...
    if calc_name == "UMA_OMAT":
        ...
        calc = NequIPCalculator.from_compiled_model(compile_path="/scratch/gpfs/ROSENGROUP/bd8619/mlip_models/NequIP-OAM-XL/NequIP-OAM-XL.pt2", device="cuda")
